   ...
   public static void main(String[] args) {
    ...
    Consumer<String> consumer
        ...
        consumer
            ...
            .accept("lgcns inspire"); //inspire 출력
    ...
    List<String> brands=
        Arrays.asList("samsung","lg","lgcns","inpire","camp","6th");
    ...
    System.out.println();
    System.out.println("debug>>>>collection->Stram");
    ...
    System.out.println("debug>>>> 메소드 참조 방식(type::메소드명)");
